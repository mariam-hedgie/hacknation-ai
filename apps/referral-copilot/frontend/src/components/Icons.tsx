...
function IconClipboardPulse(props: IconProps) {
  return (
    <Glyph {...props}>
...
function IconCapsule(props: IconProps) {
  return (
    <Glyph {...props}>
...
function IconTestTube(props: IconProps) {
  return (
    <Glyph {...props}>
      <path d="M9 3h6" />
...
function IconHelpCircle(props: IconProps) {
  return (
    <Glyph {...props}>
      <circle cx="12" cy="12" r="9" />
      <path d="M9.6 9.4a2.5 2.5 0 0 1 4.6 1.2c0 1.7-2.2 2.2-2.2 3.4M12 17.5h.01" />
    </Glyph>
  );
}
...
function IconNote(props: IconProps) {
  return (
    <Glyph {...props}>
...
export function IconDatabase(props: IconProps) {
  return (
    <Glyph {...props}>
      ...
      <path d="M4.5 5v14c0 1.6 3.4 3 7.5 3s7.5-1.4 7.5-3V5M4.5 12c0 1.6 3.4 3 7.5 3s7.5-1.4 7.5-3" />
    </Glyph>
  );
}
...
const OPTION_ICONS: Record<string, ComponentType<IconProps>> = {
...
export function OptionIcon({ label, ...props }: IconProps & { label: string }) {
  const Component = OPTION_ICONS[label] ?? IconMapPin;
  return <Component {...props} />;
}

const EVIDENCE_ICONS: Record<string, ComponentType<IconProps>> = {
...
export function EvidenceIcon({ status, ...props }: IconProps & { status: string }) {
  const Component = EVIDENCE_ICONS[status] ?? IconHelpCircle;
  return <Component {...props} />;
}
